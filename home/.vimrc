...
" Section: configuration
  ...
  augroup myfiletypes
    ...
    " Section: javascript
      autocmd BufRead,BufNewFile .eslintrc set ft=json
...
" Section: mappings
  ...
  map <leader>w   :let @* = expand("%").":".line(".")<CR>:echo "Copied: ".@*<CR>
  vmap <leader>w   :let @* = expand("%").":".line(".")<CR>:echo "Copied: ".@*<CR>
...
" Section: ctrlp plugin
  ...
  let g:ale_linters_explicit = 1 " only run linters that have explicitly configured
  ...
  if filereadable(".eslintrc") ||
        \filereadable(".eslintrc.json") ||
        \filereadable(".eslintrc.yaml") ||
        \filereadable(".eslintrc.yml") ||
        \filereadable(".eslintrc.js")
...
" Section: startify
  ...
  " tags alternative
  map <C-]> :CocList tags --input <C-R><C-W><CR>
  vmap <C-]> :CocList tags<CR><C-R><C-W>
